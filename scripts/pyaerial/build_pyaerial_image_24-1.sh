...
docker pull nvcr.io/qhrjhjrvlsbu/aerial-cuda-accelerated-ran:24-1-cubb

set -e

rm -rf cuBB
docker run --rm -d --name cuBB nvcr.io/qhrjhjrvlsbu/aerial-cuda-accelerated-ran:24-1-cubb
