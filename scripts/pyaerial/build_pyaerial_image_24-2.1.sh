...
docker pull nvcr.io/qhrjhjrvlsbu/aerial-cuda-accelerated-ran:24-2.1-cubb

set -e

rm -rf cuBB
docker run --rm -d --name cuBB nvcr.io/qhrjhjrvlsbu/aerial-cuda-accelerated-ran:24-2.1-cubb
...
export cuBB_SDK=`pwd`
AERIAL_BASE_IMAGE=nvcr.io/qhrjhjrvlsbu/aerial-cuda-accelerated-ran:24-2.1-cubb $cuBB_SDK/pyaerial/container/build.sh
