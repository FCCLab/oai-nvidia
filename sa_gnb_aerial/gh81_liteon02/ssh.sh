...
sudo ifconfig "$INTERFACE" 10.101.131.1/24 || {
  echo "Error: Failed to configure $INTERFACE with IP 10.101.131.1/24."
  exit 1
}
...
SSH_USER="user"
SSH_PASS="user"  # Replace with a secure method (e.g., SSH keys or prompt)
